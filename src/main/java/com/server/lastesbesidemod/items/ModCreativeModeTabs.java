...
@Mod.EventBusSubscriber(modid = LastestBesideMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModCreativeModeTabs {
    ...
    public static void registerCreativeModeTabs(CreativeModeTabEvent.Register event){
        MATERIALS_TAB = event.registerCreativeModeTab(new ResourceLocation(LastestBesideMod.MODID, "lastestbeside_tab_mat"),
        ...
        EQUIPMENT_TAB = event.registerCreativeModeTab(new ResourceLocation(LastestBesideMod.MODID, "lastestbeside_tab_equip"),
                builder -> builder.icon(() -> new ItemStack(ModItems.LYNX_SKIN.get()))
                        .title(Component.translatable("creativemodetab.lastestbeside_tab_equip")));
        MONSTERS_TAB = event.registerCreativeModeTab(new ResourceLocation(LastestBesideMod.MODID, "lastestbeside_tab_mobs"),
                builder -> builder.icon(() -> new ItemStack(ModItems.LYNX_SKIN.get()))
